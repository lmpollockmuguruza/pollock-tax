...
/* ===== SITE INTRO OPENER SYSTEM =====
  ...
  (function () {
    ...
    const T = {
      ...
      saving:   { en: 'About 10% less than filing each side separately.', es: 'Un 10% menos que presentar cada lado por separado.' },
      note:     { en: 'A guide, not a quote. The fee is fixed in writing after the call.', es: 'Es una orientación, no un presupuesto. El precio se cierra por escrito tras la llamada.' },
      noteVat:  { en: 'Spanish fees exclude IVA.', es: 'Las tarifas españolas no incluyen IVA.' },
      talk:     { en: 'Let’s talk', es: 'Hablemos' },
      openTitle:{ en: 'Let’s work it out on a call.', es: 'Lo vemos en una llamada.' },
      openBody: { en: 'Thirty minutes, no charge. You’ll leave it knowing what you need and what it costs.', es: 'Treinta minutos, sin coste. Saldrás sabiendo qué necesitas y cuánto cuesta.' },
      item: {
